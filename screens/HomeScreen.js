    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.categoryContainer}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.categoryBtnTxt}>Thức ăn nhanh</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          <View style={styles.categoryIcon}>
            <MaterialCommunityIcons name="food" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>Góc ăn vặt</Text>
        </TouchableOpacity>
      </View>
      <View style={[styles.categoryContainer, {marginTop: 10}]}>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          ...
          <Text style={styles.categoryBtnTxt}>Cửa hàng</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          <View style={styles.categoryIcon}>
            <Ionicons name="md-restaurant" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>Bữa tối</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          <View style={styles.categoryIcon}>
            <MaterialIcons name="expand-more" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>Xem thêm</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.cardsWrapper}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}>Địa điểm ăn uống tuyệt vời</Text>
            <StarRating ratings={4} reviews={99} />
            <Text style={styles.cardDetails}>
            Mô tả tuyệt vời cho địa điểm tuyệt vời này
            </Text>
          </View>
        </View>
        <View style={styles.card}>
